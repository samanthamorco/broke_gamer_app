class ProductsController < ApplicationController
  ...
  def index
    ...
    hash = Unirest.get("http://api.bestbuy.com/v1/products(categoryPath.id=abcat0700000)?show=sku,image,name,shortDescription,salePrice,onSale&pageSize=12&page=1&format=json&apiKey=5rnsy6rxdnw33npjhqnj4m4q").body
